# Tweak `/etc/sudoers`, by running (substitute nano for whichever editor you're comfortable using, default without variable is vi):

```sh
sudo EDITOR=nano visudo
```

## To entirely disable password prompts when running sudo (note that my username is banana308, substitute with yours naturally), locate the following:
...
## If you do not want this, but instead want to see the password you type within a sudo prompt, instead add this:
