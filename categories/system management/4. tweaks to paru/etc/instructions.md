# Normally, when you install things from the AUR, it will (sometimes) run a long and boring self-testing phase.
To skip these, either edit this line in your `/etc/makekpkg.conf`:
